...
BUTTON_BORDER_NOTFOCUSED = '#CCCCCC'
BUTTON_BORDER_FOCUSED = '#0078D7'
BUTTONPRESSED = '#E0E0E0'

ENTRY_BORDER_NOTFOCUSED = '#CCCCCC'
ENTRY_BORDER_FOCUSED = '#0078D7'
ENTRY_BACKGROUND = '#FFFFFF'
ENTRY_BACKGROUNDFOCUSED = '#FFFFFF'
ENTRY_CURSORCOLOR = '#000000'

DROPDOWN_INACTIVE_BACKGROUND = '#FFFFFF'
DROPDOWN_ACTIVE_BACKGROUND = '#E8F0FE'
DROPDOWN_BACKGROUND = '#FFFFFF'
DROPDOWN_MENU_BACKGROUND = '#FFFFFF'

def NewButton(parent=None,**kw):
    UWPFONT = Font(family='微软雅黑',size=11)
    ...
    if Border.winfo_height() == 1 or Border.winfo_width() == 1:
        Border.configure(height=40,width=100)
...
def NewLabel(size=19,**kw):
    UWPFONT = Font(family='微软雅黑',size=size)
    # 从kwargs中提取parent参数
    parent = kw.pop('parent', None)
    # 先创建Label，传递parent参数
    l = Label(parent, font=UWPFONT, bg=BACKGROUND_COLOR, fg=FOREGROUND_COLOR)
    # 然后应用其他参数
    l.configure(kw)
    return l
